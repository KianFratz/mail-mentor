      ...
      <div className="container mx-auto">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-base text-muted-foreground max-w-2xl mx-auto">
            Advanced simulation tools designed to transform how you think about
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto">
            ...
            <div className="h-full flex flex-col justify-between">
              <div>
                ...
                <p className="text-muted-foreground">
                  Practice six scenarios across Workplace, Job Applications,
                  Academic, and Customer Service contexts.
                </p>
              </div>
          ...
          <div className="md:col-span-5 bg-tertiary text-tertiary-foreground p-8 rounded-2xl shadow-lg relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-white/80">
                End a writing session to receive category scores, strengths,
                improvement areas, and a suggested revision.
              </p>
            </div>
          ...
          <div className="md:col-span-12 bg-success/10 p-8 rounded-2xl border border-success/20 flex flex-col md:flex-row gap-8 items-center">
            <div className="md:w-1/2 space-y-4">
              ...
              <p className="text-muted-foreground">
                Beyond simple emails, engage in back-and-forth role-play. The AI
                persona reacts to your responses, creating a dynamic learning
                loop that mirrors high-stakes conversations.
              </p>
              <a
                href="/login"
                className="text-success text-sm font-semibold flex items-center gap-2 hover:gap-3 transition-all"
              >
                Explore scenarios{" "}
